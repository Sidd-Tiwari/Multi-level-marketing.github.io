        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    $day_bal = $result['day_bal'] ?? 'N/A';
                    $current_bal = $result['current_bal'] ?? 'N/A';
                    $total_bal = $result['total_bal'] ?? 'N/A';
                    $pin_count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM pin_list WHERE userid='$userid' AND status='open'"));
                    ?>
                    <div class="col-lg-3">
