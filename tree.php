                    ...
                    <div class="table-responsive">
                        <table class="table" align="center" border="0" style="text-align:center">
                            ...
                            <tr height="150">
                                ...
                                ?>
                                <?php if($second_left_user != null){ ?>
                                    <td>
                                        <a href="tree.php?search-id=<?php echo $second_left_user; ?>">
                                            <i class="fa fa-user fa-4x" style="color:#361515"></i>
                                ...
                                <?php } ?>
                                <?php if($third_right_user != null){ ?>
                                    <td>
                                        <a href="tree.php?search-id=<?php echo $third_right_user; ?>">
                                            <i class="fa fa-user fa-4x" style="color:#361515"></i>
                                            <p><?php echo $third_right_user; ?></p>
                                        </a>
                                    </td>
                                <?php } else { ?>
                                    <td>
