...
if(isset($_GET['join_user'])){
	...
	if($flag==1){
		...
		$query = mysqli_query($con,"insert into users(`email`,`password`,`mobile`,`address`,`account`,`under_userid`,`side`) values('$email','$password','$mobile','$address','$account','$under_userid','$side')");
